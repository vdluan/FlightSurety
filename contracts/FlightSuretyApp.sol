...
contract FlightSuretyApp {
    ...
    FlightSuretyData flightSuretyData; // link to FlightSuretyData
    ...
    *
    */   
    function registerAirline(address airline, string calldata name) external  returns(bool)
    {
    ...
    */  
    ...
    {
        return flightSuretyData.viewFlightStatus(airline, flight, timestamp);
    }
 ...
 //for testing only 
   function getInsurance(address airline, string calldata flight, uint256 timestamp, address insuree) external returns(uint256 v)
    {
        return flightSuretyData.getInsurance(airline, flight, timestamp, insuree);
    }
    ...
    */
     ...
     *
    */
    function payInsurance() external payable returns(uint256)
    {
       uint256 value= flightSuretyData.payInsurance(msg.sender);
...
/**
    ...
    *
    */  
    function processFlightStatus(address airline, string memory flight, uint256 timestamp, uint8 status)  internal
    {
        flightSuretyData.processFlightStatus(airline, flight, timestamp, status);
    }
...
contract FlightSuretyData {
    ...
    function buyInsurance(address airline, string calldata flight, uint256 timestamp, address sender, uint256 value) external payable;
    function getInsurance(address airline, string calldata flight, uint256 timestamp, address insuree) external returns(uint256 v);
    function creditInsurees(address airline, string calldata flight, uint256 timestamp) external;
    function payInsurance(address payable sender) external payable returns(uint);
